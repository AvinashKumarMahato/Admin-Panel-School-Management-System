...
const AddTeacher = () => {
    ...
    const [expert, setExpert] = useState('English')
        ...
        <form onSubmit={onSubmitHandler} className='m-5 w-full'>
            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                <div className='flex items-center gap-4 mb-8 text-gray-500'>
                    ...
                    <input onChange={(e) => setTeacherImg(e.target.files[0])} type="file" name="" id="doc-img" hidden />
                ...
                <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            <p>Salary</p>
                            <input onChange={e => setSalary(e.target.value)} value={salary} className='border rounded px-3 py-2' type="number" placeholder='Teacher Salary' required />
                        </div>
                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            <p>Expert</p>
                            <select onChange={e => setExpert(e.target.value)} value={expert} className='border rounded px-2 py-2'>
                ...
                <div>
                    ...
                    <textarea onChange={e => setAbout(e.target.value)} value={about} className='w-full px-4 pt-2 border rounded' rows={5} placeholder='write about teacher'></textarea>
                </div>
